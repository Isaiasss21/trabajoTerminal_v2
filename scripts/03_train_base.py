...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train Base model with LOSO or split validation")
    parser.add_argument("--features_index", required=True, help="CSV maestro")
    parser.add_argument("--out_dir", default="outputs/exp_base", help="Output folder")
